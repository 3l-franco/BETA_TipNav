...
class _MapPageState extends State<MapPage> {
  ...
  AnimatedSlide(
    ...
    offset: _showCard ? Offset.zero : const Offset(0, 1), // 👈 controls animation
...
Future<void> _addMultiplePins() async {
  ...
  List<Map<String, dynamic>> locations = [
    ...
    {
      "position": Position(121.06169804041711, 14.625643937971176), // pe center 1
    ...
    {
      "position": Position(121.06122300580736, 14.62568436671969), // pe center 2
      "image": "images/pins/GymPin.png",
      "id": "bldg6",
      "name": "PE CENTER 2",
      "floor": "5F",
    ...
    {
      "position": Position(121.0622595820087, 14.62590351556203), // anniv. hall
    ...
    {
      "position": Position(121.06281733491983, 14.625690757753244), // technocore
      "image": "images/pins/BuildingPin.png",
      "id": "bldg6",
      "name": "TECHNOCORE",
      "floor": "5F",
    ...
    {
      "position": Position(121.06212337809318, 14.625313374192332), // study hall
  ...
  final ByteData bytes =
      await DefaultAssetBundle.of(context).load(loc["image"]);
 ...
 Widget _buildLocationCard() {                   // LOCATION CARDDDD //  <-----------------

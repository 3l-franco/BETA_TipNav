...
import 'saved.dart';
import 'dart:io'; // LEM
import 'package:firebase_auth/firebase_auth.dart'; // LEM
import 'package:image_picker/image_picker.dart' as picker; // LEM
...
Future<void> setup() async {
  ...
  // Mapbox access token removed for security. Set this at runtime or with a safe method.
}
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: MapWidget(
                    styleUri:
                        "mapbox://styles/aldringa/cmmw6cqju00dm01sk91ihcifz",
...
// LEM - changed to StatefulWidget to handle local photo pick
...
class _AppHeaderState extends State<AppHeader> {
  // LEM - stores the picked photo locally, no firebase upload
  File? _pickedPhoto;

  // LEM - opens gallery to pick photo, just for display demo
  Future<void> _pickPhoto() async {
    // LEM - using picker prefix to avoid conflict with mapbox ImageSource
    final picker.ImagePicker imgPicker = picker.ImagePicker();
    final picker.XFile? picked = await imgPicker.pickImage(
  ...
  @override
  Widget build(BuildContext context) {
    // LEM - get real username from firebase auth
    final user = FirebaseAuth.instance.currentUser;
    final String displayName = user?.displayName ?? 'TIPian';
        ...
        children: [
          Row(
            children: [
              ...
              // LEM - tappable avatar, shows initials or picked photo
              GestureDetector(
                onTap: _pickPhoto,
                child: Stack(
                  children: [
